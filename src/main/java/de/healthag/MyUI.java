 ...
 */
@Theme( "mytheme" )
//@Widgetset( "de.healthag.MyAppWidgetset" )
public class MyUI
    extends UI
{
    ...
    {
        MyGridComponent c = new MyGridComponent();
        setContent( c.getComponent() );
    }

    @WebServlet( urlPatterns = "/*", name = "MyUIServlet", asyncSupported = true )
    @VaadinServletConfiguration(widgetset="de.healthag.MyAppWidgetset", ui = MyUI.class, productionMode = false )
